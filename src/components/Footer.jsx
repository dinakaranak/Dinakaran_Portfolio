...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="section-container bg-gradient-to-b from-gray-900 to-gray-800 pt-10 pb-4">
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        <h2 className={`text-4xl md:text-5xl font-bold text-center mb-4 text-white opacity-0 transition-opacity duration-700 ${isVisible ? 'opacity-100' : ''}`}>
          <span className="relative inline-block">
            <span className="absolute -inset-2 bg-indigo-600 opacity-20 blur-md"></span>
          ...
          <div className={`opacity-0 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
            <form onSubmit={handleSubmit} className="bg-gray-825 p-6 rounded-xl border border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
                >
                  Send Message
