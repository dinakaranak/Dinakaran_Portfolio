...
import profileImage from '../assets/IMG_1043.png'
import pdf from '../assets/DinakaranResume.pdf'
     ...
     section-container md:pt-20 px-4">
      <div className="container max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          >
            I am a MERN Stack Developer with experience in designing and developing 
            scalable web applications. Skilled in MongoDB, Express.js, React.js, and Node.js, 
            I have worked on projects like Billing Software, Library Management System,
            and Portfolio Website. My skills include CRUD operations, authentication, 
            API integration, and deployment on platforms such as AWS, Vercel, and MongoDB Atlas.
            I focus on creating efficient and user-friendly solutions.
          </motion.p>
        ...
        >
          <div className="relative">
            <motion.div 
              className="w-56 h-56 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-blue-500 shadow-2xl shadow-blue-500/30 mx-auto"
