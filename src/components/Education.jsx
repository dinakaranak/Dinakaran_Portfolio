...
const Education = () => {
  ...
  return (
    <section id="education" className="section-container py-10 md:py-10 bg-gradient-to-b from-gray-800 to-gray-900">
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        <h2 className={`section-title text-4xl md:text-5xl font-bold text-center mb-16 text-white opacity-0 transition-opacity duration-700 ${isVisible ? 'opacity-100' : ''}`}>
          <span className="relative inline-block">
            <span className="absolute -inset-2 bg-purple-600 opacity-20 blur-md"></span>
            <span className="relative bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">
              Education
            </span>
          </span>
        </h2>
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 md:left-1/2 top-10 bottom-20 w-1 bg-gradient-to-b from-purple-500 to-pink-500 transform -translate-x-1/2 md:translate-x-0 rounded-full"></div>
          ...
          <div className="space-y-12">
            {education.map((edu, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-4 md:left-1/2 top-6 w-6 h-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 transform -translate-x-1/2 md:translate-x-0 z-10 flex items-center justify-center">
                ...
                <div className="ml-12 md:ml-0 md:w-1/2 bg-gray-825 border border-gray-700 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="bg-gradient-to-r from-purple-800 to-pink-800 text-purple-100 px-3 py-1 rounded-full text-xs md:text-sm font-medium whitespace-nowrap">
                      {edu.period}
                    </span>
                  </div>
                  
                  <h4 className="text-lg md:text-xl font-semibold text-purple-400 mb-3 flex items-center">
